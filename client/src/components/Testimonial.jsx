  ...
  const testimonials = [
    {
      ...
      testimonial:
        "I've rented cars from various companies, but the experince with CarRental was exceptional.",
    },
    {
      name: "John Smith",
      ...
      testimonial:
        "CarRental made my trip so much easier. the car was delivered right to mt door, and the customer service was fantastic!",
    },
    {
      name: "Ava Johnson",
